    ...
    <nav className=" visible fixed top-0 z-10 flex h-16 w-full items-center  overflow-x-hidden border-b border-slate-400/50 bg-black px-5 md:hidden">
      ...
      >
        <Image
          ...
          // placeholder="blur"
        />
        <div className="navTitle z-10 my-auto mr-20 bg-black text-2xl font-bold text-slate-100">
          TweetNet
        </div>
      </Link>
      ...
      <div className="hover:scale105 flex items-center">
        {isSignedIn && (
          <>
            <div className="hover:scale105 hover: mx-auto   block whitespace-nowrap rounded-xl px-3 py-1 ring-slate-100/90 hover:bg-slate-500/30">
              <Link
                href="/"
