    ...
    .mutation(async ({ ctx, input }) => {
      ...
      for (const bot of shuffledBots) {
        ...
        const tweetTemplateStrings = [
          ...
          `<a list of top 5 things related to ${dreams} and a product or service>.`,
          `<a list of top 5 things related to ${job} >.  `,
          `<a list of top 5 things related to ${dislikes} >.`,
          `<a list of top 5 things related to ${likes} >. `,
          `<a list of top 5 things related to ${location} >. `,
